...
const Portfolio = () => {
  const handleDownload = ()=>{
    confirm("Portfolio has been saved!")
  }
  return (
    <div>
      <Navbar />
      <div className="h-[100vh] bg-[url(../src/assets/portfolio.avif)] bg-cover bg-bottom">
        <div className="h-[100vh] bg-black/90 p-20">
          <h2 className="flex justify-center items-center gap-2 text-white my-10 text-3xl font-bold">Download Portfolio <img onClick={handleDownload} className="download h-8" src={download} /></h2>
